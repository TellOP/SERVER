...
class FeaturedNotDoneController extends WebServiceClientController {
    /**
     * Returns a list of all featured exercises not done by the current user.
    ...
    public function displayPage($appObject) {
        ...
        $out = json_encode(Activity::getFeaturedAndNotDoneExercises($appObject, $this->getOAuthUsername(), $lang));
        echo $out;
