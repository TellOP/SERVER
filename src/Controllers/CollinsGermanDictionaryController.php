...
class CollinsGermanDictionaryController extends WebServiceClientController {
    /**
     * Performs a query to the Collins German Dictionary Web service.
    ...
    public function displayPage($appObject) {
        ...
        $curlHandle = $this->curlOpen(
            'https://api.collinsdictionary.com/api/v1/dictionaries/german-english/search/?q='
