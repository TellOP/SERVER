            ...
            <form method="post" action="/register" data-toggle="validator">
                ...
                <div class="form-box">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control<?php if ((isset($passworderror) && $passworderror) || (isset($wrongoldpw) && $wrongoldpw)) {echo ' has-error';} ?>" id="password" placeholder="<?php echo _('Current password'); ?>" data-error="<?php echo _('You must enter your current password.'); ?>" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control<?php if (isset($newpassworderror) && $newpassworderror) {echo ' has-error';} ?>" id="newpassword" placeholder="<?php echo _('New password'); ?>" data-error="<?php echo _('You must enter your new password.'); ?>" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control<?php if ((isset($newpasswordconfirmerror) && $newpasswordconfirmerror) || (isset($newpasswordsmatcherror) && $newpasswordsmatcherror)) {echo ' has-error';} ?>" id="newpasswordconfirm" placeholder="<?php echo _('Confirm new password'); ?>" data-error="<?php echo _('The passwords do not match.'); ?>" required>
