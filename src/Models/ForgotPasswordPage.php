    ...
    <form method="post" action="/forgotpassword" data-toggle="validator">
        ...
        <div class="form-box">
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control<?php if (isset($emailerror)) {echo ' has-error';} ?>" id="email" placeholder="<?php echo _('E-mail address'); ?>" data-error="<?php echo _('You must enter a valid e-mail address.'); ?>" required<?php if (isset($_POST['email'])) {echo ' value="'.htmlspecialchars($_POST['email']).'"';} ?>>
